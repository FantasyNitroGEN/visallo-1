...
public class VideoPosterFrameWorker extends GraphPropertyWorker {
    ...
    public void prepare(GraphPropertyWorkerPrepareData workerPrepareData) throws Exception {
        ...
        durationProperty = new DoubleVisalloProperty(getOntologyRepository().getRequiredPropertyIRIByIntent("media.duration", PUBLIC));
    ...
    public void execute(InputStream in, GraphPropertyWorkData data) throws Exception {
        ...
        try {
            ...
            try (InputStream videoPosterFrameFileIn = new FileInputStream(videoPosterFrameFile)) {
                ...
                StreamingPropertyValue spv = StreamingPropertyValue.create(videoPosterFrameFileIn, byte[].class);
