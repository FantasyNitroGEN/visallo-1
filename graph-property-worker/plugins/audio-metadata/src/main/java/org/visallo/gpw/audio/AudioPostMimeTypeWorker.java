...
public class AudioPostMimeTypeWorker extends PostMimeTypeWorker {
    ...
    public void prepare(GraphPropertyWorkerPrepareData workerPrepareData) throws Exception {
        ...
        // TODO: поидее должно быть чисто PUBLIC, но только так
        duration = new DoubleVisalloProperty(ontologyRepository.getRequiredConceptIRIByIntent("media.duration", OntologyRepository.PUBLIC));
//        duration = new DoubleVisalloProperty(ontologyRepository.getRequiredPropertyIRIByIntent("media.duration"));
        fileSize = new IntegerVisalloProperty(ontologyRepository.getRequiredPropertyIRIByIntent("media.filesize",OntologyRepository.PUBLIC));
