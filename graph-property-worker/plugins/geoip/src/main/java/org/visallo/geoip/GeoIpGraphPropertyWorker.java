...
public class GeoIpGraphPropertyWorker extends GraphPropertyWorker {
    ...
    public void prepare(GraphPropertyWorkerPrepareData workerPrepareData) throws Exception {
        ...
        String geoLocationIri = getOntologyRepository().getRequiredPropertyIRIByIntent(GEO_LOCATION_INTENT, PUBLIC);
    ...
    public void execute(InputStream in, GraphPropertyWorkData data) throws Exception {
        ...
        PropertyMetadata metadata = new PropertyMetadata(getUser(), data.getElementVisibilityJson(), data.getVisibility());
        ...
        geoLocationProperty.updateProperty(changedProperties, data.getElement(), m, data.getProperty().getKey(), geoPoint, metadata);
