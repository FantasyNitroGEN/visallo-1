...
public class CsvGraphPropertyWorker extends GraphPropertyWorker {
    ...
    public void prepare(GraphPropertyWorkerPrepareData workerPrepareData) throws Exception {
        ...
        //TODO: добавил PUBLIC
        hasEntityIri = getOntologyRepository().getRequiredRelationshipIRIByIntent("artifactHasEntity", PUBLIC);
        csvConceptTypeIri = getOntologyRepository().getConceptIRIByIntent("csv", PUBLIC);
    }
    ...
    private Vertex createEntity(State state, Mapping.Vertex mappingVertex, String hash) {
        ...
        for (Mapping.Property property : mappingVertex.getProperties()) {
            try {
                ...
                //TODO добавил getUser
                Metadata metadata = state.getData().createPropertyMetadata(getUser());
        ...
        if (!foundVisibilityJson) {
            // TODO: изменил на getElementVisibilityJSON
            VisibilityJson visibilityJson = state.getData().getElementVisibilityJson();
