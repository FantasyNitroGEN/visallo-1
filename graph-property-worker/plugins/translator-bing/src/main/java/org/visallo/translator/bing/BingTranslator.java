package org.visallo.translator.bing;
...
import org.visallo.translate.Translator;
...
@Name("Bing")
@Description("Uses Bing Translator to translate text")
public class    BingTranslator implements Translator {
    private static final VisalloLogger LOGGER = VisalloLoggerFactory.getLogger(BingTranslator.class);
    ...
    public String translate(String text, String language, GraphPropertyWorkData data) {
        ...
        try {
            ...
            //api.microsofttranslator.com/V2/Ajax.svc/Translate заменнено на api.cognitive.microsofttranslator.com/translate?api-version=3.0&
            String urlString = "https://api.cognitive.microsofttranslator.com/translate?api-version=3.0&";
            urlString += "?to=en";
            ...
            throw new VisalloException("Could not translate text", ex);
        }
    }
    ...
    private void ensureUpToDateToken() {
        ...
        try {
            ...
            //http://api.microsofttranslator.com замененено на api.cognitive.microsofttranslator.com
            String scope = "http://api.cognitive.microsofttranslator.com";
            ...
            throw new VisalloException("Could not refresh the token", ex);
        }
    }
