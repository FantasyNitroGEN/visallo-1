...
public class GeoLocationResolverGraphPropertyWorker extends GraphPropertyWorker {
    ...
    public void prepare(GraphPropertyWorkerPrepareData workerPrepareData) throws Exception {
        ...
        geoLocationProperty = getOntologyRepository().getRequiredVisalloPropertyByIntent(GEO_LOCATION_INTENT, GeoPointVisalloProperty.class, PUBLIC);
        locationProperty = getOntologyRepository().getRequiredVisalloPropertyByIntent(LOCATION_INTENT, StringVisalloProperty.class, PUBLIC);
    }
