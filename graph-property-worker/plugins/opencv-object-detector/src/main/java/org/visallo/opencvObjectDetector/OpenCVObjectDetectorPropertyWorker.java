...
public class OpenCVObjectDetectorPropertyWorker extends GraphPropertyWorker {
    ...
    public void prepare(GraphPropertyWorkerPrepareData workerPrepareData) throws Exception {
        ...
        for (Map.Entry<String, Map<String, String>> classifierConceptEntry : classifierConcepts.entrySet()) {
            ...
            if (objectClassifier.empty()){
                throw new VisalloException("Could not find haarcascade_frontalface_alt.xml");
            }
            String conceptIRI = getOntologyRepository().getRequiredConceptIRIByIntent(classifierConcept, PUBLIC);
    ...
    public void execute(InputStream in, GraphPropertyWorkData data) throws Exception {
        ...
        BufferedImage bImage = thumbnailRepository.getTransformedImage(originalImage, artifactVertex, data.getProperty().getKey());
