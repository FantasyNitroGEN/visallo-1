...
public class OpenNLPDictionaryExtractorGraphPropertyWorker extends GraphPropertyWorker {
    ...
    private Map<String, Dictionary> getDictionaries() {
        ...
        //Iterable<DictionaryEntry> entries = dictionaryEntryRepository.findAll(UserRepository.getSimpleOrmContext());
        Iterable<DictionaryEntry> entries = dictionaryEntryRepository.findAll(simpleOrmContextProvider.getContext(getUser()));
