...
public class GeocoderGraphPropertyWorker extends GraphPropertyWorker {
    ...
    public void prepare(GraphPropertyWorkerPrepareData workerPrepareData) throws Exception {
        ...
        geocodableProperties = getOntologyRepository().getPropertiesByIntent(INTENT_GEOCODABLE, PUBLIC);
        geoLocationProperty = getOntologyRepository().getRequiredPropertyByIntent(INTENT_GEO_LOCATION, PUBLIC);
    ...
    private String getLocationString(Element element, Property property, String workspaceId) {
        OntologyProperty dependentPropertyParent = getOntologyRepository().getDependentPropertyParent(property.getName(), workspaceId);
        if (dependentPropertyParent != null) {
            ...
            FormulaEvaluator.UserContext userContext = new FormulaEvaluator.UserContext(locale, null, timeZone, workspaceId);
