        ...
        if (!language.equals("en") && !hasTranslatedProperty(data, translatedTextPropertyKey)) {
            ...
            if (translatedText != null && translatedText.length() > 0) {
                ...
                if (data.getProperty().getValue() instanceof StreamingPropertyValue) {
                    //StreamingPropertyValue translatedTextValue = StreamingPropertyValue.create(new ByteArrayInputStream(translatedText.getBytes(), String.class))
                    translatedTextValue = StreamingPropertyValue.create(new ByteArrayInputStream(translatedText.getBytes()), String.class);
                } else {
