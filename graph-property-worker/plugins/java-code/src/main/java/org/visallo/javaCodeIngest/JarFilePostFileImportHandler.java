...
public class JarFilePostFileImportHandler extends PostFileImportHandler {
    ...
    public void handle(
        ...
        VisalloProperties.CONCEPT_TYPE.updateProperty(changedProperties, vertex, m, JavaCodeIngestOntology.CONCEPT_TYPE_JAR_FILE, propertyMetadata);
        ...
        VisalloProperties.MIME_TYPE.updateProperty(changedProperties, vertex, m, MULTI_VALUE_KEY, "application/java-archive", propertyMetadata);
